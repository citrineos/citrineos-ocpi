...
export type UpdateLocationPublicationStatusMutationResult = {
  update_Locations?: {
...
export type UpdateEvsePublicationStatusMutationResult = {
  update_Evses?: {
    affected_rows: number
  } | null
};
...
export type UpdateConnectorPublicationStatusMutationResult = {
  update_Connectors?: {
    affected_rows: number
  } | null
};
...
export type UpdateTariffPublicationStatusMutationVariables = Exact<{
  id: Scalars['Int']['input'];
  isPublished: Scalars['Boolean']['input'];
  publishedToPartners?: InputMaybe<Scalars['jsonb']['input']>;
  validationErrors?: InputMaybe<Scalars['jsonb']['input']>;
...
export type UpdateTariffPublicationStatusMutationResult = {
  update_Tariffs?: {
    affected_rows: number
  } | null
};
