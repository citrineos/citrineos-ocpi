...
export const buildPutChargingProfileParams = (
  ...
  const params = buildOcpiRegistrationParams(VersionNumber.TWO_DOT_TWO_DOT_ONE, token);
  ...
  (params as PutChargingProfileParams).activeChargingProfile = activeChargingProfile;
  (params as PutChargingProfileParams).url = url;
  console.log(`Built PutChargingProfileParams: ${JSON.stringify(params as PutChargingProfileParams)}`);
