  ...
  async request<T extends ZodTypeAny>(
    ...
    switch (httpMethod) {
      ...
      case HttpMethod.Post:
        ...
        this.logOutboundRequest(HttpMethod.Post, url, body, options.additionalHeaders);
      ...
      case HttpMethod.Put:
        ...
        this.logOutboundRequest(HttpMethod.Put, url, body, options.additionalHeaders);
      ...
      case HttpMethod.Patch:
        ...
        this.logOutboundRequest(HttpMethod.Patch, url, body, options.additionalHeaders);
        return this.updateRaw<T>(url, body, options, restClient).then(
          (response) => this.handleResponse(schema, response),
        );
      case HttpMethod.Delete:
        this.logger.info(`Sending DELETE request to ${url}`);
        this.logOutboundRequest(HttpMethod.Delete, url, body, options.additionalHeaders);
