...
# filtered by Tenant (to-headers = our eMSP identity FR/ZTA).
# Tokens pushed by partner FR/TMS in Phase 1 have tenantPartnerId set,
# so they are excluded from this endpoint (same pattern as Tariffs).
# These tests validate that the endpoint responds correctly; the data
# list will be empty unless own tokens (tenantPartnerId NULL) exist.
# ===========================================================================
